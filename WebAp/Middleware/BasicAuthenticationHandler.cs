...
namespace WebAp
{
    ...
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public BasicAuthenticationHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, IUserAuthenticationService service) : base(options, logger, encoder, (ISystemClock)clock)
        {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            //var isAllowAnonymos = endpoint?.Metadata.Any(x => x.GetType() == typeof(AllowAnonymousAttribute));
